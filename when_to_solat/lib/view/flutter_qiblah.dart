...
import 'package:when_to_solat/view/loading_indicator.dart.dart';
import 'package:when_to_solat/view/qiblah_compass.dart';
import 'package:when_to_solat/view/qiblah_maps.dart';

// ignore: camel_case_types
class qblahDirection extends StatefulWidget {
  const qblahDirection({Key? key}) : super(key: key);

  @override
  State<qblahDirection> createState() => _qblahDirectionState();
}

class _qblahDirectionState extends State<qblahDirection> {
