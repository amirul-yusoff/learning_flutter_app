...
$projectQuery = $pdo->prepare("SELECT Project_Code, Project_Short_name FROM project_registry WHERE Project_Status = 'Work In Progress' || Project_Status = 'Active' || Project_Status = 'TOC/CPC' || Project_Status = 'CC/CMGD' ORDER BY Project_ID DESC");
